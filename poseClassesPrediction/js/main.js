 ...
 * -------------------------------------------------
 *
 * This Example is using a preTrained prediction model with three classes 
 * (A - right hand up; B - left hand up; Z - every other pose)
 *   
 */
...
function setup() {
  ...
  console.log("load model and start prediction");
  loadDataset("model");
  startPrediction();
